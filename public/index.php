...
$router->add('POST', '/assets/assign-existing', 'AssetController', 'assignExistingAsset');
...
$router->add('GET', '/api/provider-assets', 'AssetController', 'getProviderInstanceAssets');
