...
auth_curl -X POST -d "label=GLTest&base_url=https://gitlab.example.com&api_token=tok" "http://localhost:8080/w/${TENANT_SLUG}/gitlab/settings" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "instance_id=${GL_INST_ID}&employee_id=${EMP_ID}&gitlab_user_id=42&resource_type=project&resource_id=123&resource_name=ProjX&access_level=30" "http://localhost:8080/w/${TENANT_SLUG}/gitlab/grant" >/dev/null 2>&1 || true
...
auth_curl -X POST "http://localhost:8080/w/${TENANT_SLUG}/gitlab/revoke/${GRANT_ID}" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "label=MCTest&base_url=https://mailcow.example.com&api_key=akey" "http://localhost:8080/w/${TENANT_SLUG}/mailcow/settings" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "instance_id=${MC_INST_ID}&local_part=jane.doe&domain=example.com&name=Jane%20Doe&password=secret&employee_id=${EMP_ID}" "http://localhost:8080/w/${TENANT_SLUG}/mailcow/create-mailbox" >/dev/null 2>&1 || true
...
# 3) Jira — add instance
auth_curl -X POST -d "label=JiraTest&base_url=https://jira.example.com&admin_email=admin@x.com&api_token=tok" "http://localhost:8080/w/${TENANT_SLUG}/jira/settings" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "instance_id=${JI_INST_ID}&employee_id=${EMP_ID}&project_key=PROJ&project_name=ProjName&jira_account_id=ja123&role_name=Member" "http://localhost:8080/w/${TENANT_SLUG}/jira/grant" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "label=ConfTest&base_url=https://conf.example.com&admin_email=admin@x.com&api_token=tok" "http://localhost:8080/w/${TENANT_SLUG}/confluence/settings" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "instance_id=${CF_INST_ID}&employee_id=${EMP_ID}&space_key=SPC1&space_name=Docs&confluence_account_id=cf_jane&permission_type=read" "http://localhost:8080/w/${TENANT_SLUG}/confluence/grant" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "label=KC&base_url=https://kc.example.com&realm=test&admin_client_id=admin-cli&admin_client_secret=sek" "http://localhost:8080/w/${TENANT_SLUG}/keycloak/settings" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "instance_id=${KC_INST_ID}&employee_id=${EMP_ID}&keycloak_user_id=kc_jane&username=Jane%20Doe" "http://localhost:8080/w/${TENANT_SLUG}/keycloak/link" >/dev/null 2>&1 || true
...
auth_curl -X POST "http://localhost:8080/w/${TENANT_SLUG}/keycloak/unlink/${LINK_ID}" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "label=PB&base_url=https://pb.example.com&api_key=tok" "http://localhost:8080/w/${TENANT_SLUG}/passbolt/settings" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "instance_id=${PB_INST_ID}&employee_id=${EMP_ID}&passbolt_user_id=pb_jane&username=Jane%20Doe" "http://localhost:8080/w/${TENANT_SLUG}/passbolt/link" >/dev/null 2>&1 || true
...
auth_curl -X POST "http://localhost:8080/w/${TENANT_SLUG}/passbolt/unlink/${PBLINK_ID}" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "label=NC&base_url=https://nc.example.com&admin_username=admin&admin_password=secret" "http://localhost:8080/w/${TENANT_SLUG}/nextcloud/settings" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "instance_id=${NC_INST_ID}&employee_id=${EMP_ID}&nc_user_id=jane.doe&nc_display_name=Jane%20Doe" "http://localhost:8080/w/${TENANT_SLUG}/nextcloud/link" >/dev/null 2>&1 || true
...
auth_curl -X POST "http://localhost:8080/w/${TENANT_SLUG}/nextcloud/unlink/${NCLINK_ID}" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "name=NewHire&description=Test&task_title[]=Setup%20Email&task_due_days[]=1" "http://localhost:8080/w/${TENANT_SLUG}/onboarding/templates" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "employee_id=${EMP_ID}&template_id=${TPL_ID}" "http://localhost:8080/w/${TENANT_SLUG}/onboarding/start" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "name=Monthly&base_amount=3000&currency=USD&pay_frequency=monthly" "http://localhost:8080/w/${TENANT_SLUG}/payroll/structures" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "name=Allowance&type=earning&calc_type=fixed&amount=100&sort_order=1" "http://localhost:8080/w/${TENANT_SLUG}/payroll/structure/${STRUCT_ID}/component" >/dev/null 2>&1 || true
auth_curl -X POST -d "employee_id=${EMP_ID}&structure_id=${STRUCT_ID}&custom_base=&effective_from=$(date +%F)" "http://localhost:8080/w/${TENANT_SLUG}/payroll/assignments" >/dev/null 2>&1 || true
auth_curl -X POST -d "period_start=$(date +%F)&period_end=$(date +%F)" "http://localhost:8080/w/${TENANT_SLUG}/payroll/run" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "title=Team%20Meeting&start_at=$(date +%F)T09:00:00&end_at=$(date +%F)T10:00:00&all_day=0" "http://localhost:8080/w/${TENANT_SLUG}/calendar/event" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "title=Hello%20Team&content=Welcome" "http://localhost:8080/w/${TENANT_SLUG}/announcements" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "bot_token=testtoken123" "http://localhost:8080/w/${TENANT_SLUG}/telegram/settings" >/dev/null 2>&1 || true
...
auth_curl -X POST -d "employee_id=${EMP_ID}" "http://localhost:8080/w/${TENANT_SLUG}/telegram/chat/tg-1001/assign" >/dev/null 2>&1 || true
