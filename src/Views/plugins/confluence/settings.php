...
<h3>Add Instance</h3>
<form method="post" action="<?= $prefix ?>/confluence/settings">
    <div class="form-group"><label>Label</label><input name="label" required></div>
    <div class="form-group"><label>Base URL</label><input name="base_url" placeholder="https://yourcompany.atlassian.net/wiki" required></div>
