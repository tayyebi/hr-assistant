<h2>Documents (Nextcloud)</h2>
<?php if (empty($instances)): ?>
    <p style="color:#666;">No Nextcloud instances configured. <a href="<?= $prefix ?>/nextcloud/settings">Add one</a>.</p>
<?php else: ?>
    ...
    <?php foreach ($instances as $i): ?>
        <tr>
            ...
            <td><a href="<?= $prefix ?>/nextcloud/instance/<?= $i['id'] ?>" class="btn btn-sm">Manage</a></td>
        </tr>
    <?php endforeach; ?>
    </tbody></table>
<?php endif; ?>
