...
<?php if (empty($instances)): ?>
    <p style="color:#666;">No GitLab instances configured. <a href="<?= $prefix ?>/gitlab/settings">Add one</a>.</p>
<?php else: ?>
    ...
    <?php foreach ($instances as $i): ?>
        <tr>
            ...
            <td><a href="<?= $prefix ?>/gitlab/instance/<?= $i['id'] ?>" class="btn btn-sm">Manage</a></td>
        </tr>
    <?php endforeach; ?>
    </tbody></table>
<?php endif; ?>
