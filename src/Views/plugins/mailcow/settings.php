...
<h3>Add Instance</h3>
<form method="post" action="<?= $prefix ?>/mailcow/settings">
    <div class="form-group"><label>Label</label><input name="label" required></div>
    <div class="form-group"><label>Base URL</label><input name="base_url" placeholder="https://mail.example.com" required></div>
    <div class="form-group"><label>API Key</label><input name="api_key" required></div>
