...
<?php if (empty($instances)): ?>
    <p style="color:#666;">No Passbolt instances configured. <a href="<?= $prefix ?>/passbolt/settings">Add one</a>.</p>
<?php else: ?>
    ...
    <?php foreach ($instances as $i): ?>
        <tr>
            ...
            <td><a href="<?= $prefix ?>/passbolt/instance/<?= $i['id'] ?>" class="btn btn-sm">Manage</a></td>
        </tr>
    <?php endforeach; ?>
    </tbody></table>
<?php endif; ?>
